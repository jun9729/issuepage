...
urls = "https://search.naver.com/search.naver?sm=tab_hty.top&where=news&query=LH&oquery=%EB%AC%B4%EC%95%BC%ED%98%B8&tqi=harxXwprvmsssuB2WRCssssstyl-388509"
links = []
news_names = 'LH'
posts_len = 0
...
while True:
    ...
    try:
        if tesla_youtue:
            ...
            search = SearchVideos("LH", offset=1, mode="dict", max_results=20)
