...
urls = "https://search.naver.com/search.naver?sm=tab_hty.top&where=news&query=%EB%A1%A4%EB%A6%B0&oquery=%EB%AC%B4%EC%95%BC%ED%98%B8&tqi=harxhlprvOsssZcYpUKssssstBG-013761"
links = []
news_names = 'lollin'
posts_len = 0
