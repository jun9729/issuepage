...
urls = "https://search.naver.com/search.naver?sm=tab_hty.top&where=news&query=%EB%AC%B4%EC%95%BC%ED%98%B8&oquery=%EC%95%A0%ED%94%8C&tqi=harFxlprvh8ssewE9b4ssssstaR-480194"
links = []
news_names = 'apple'
posts_len = 0
...
while True:
    ...
    try:
        if tesla_youtue:
            ...
            search = SearchVideos("무야호", offset=1, mode="dict", max_results=20)
